...
def parse_args():
    ...
    parser.add_argument(
        "--lora_model_path",
        type=str,
        default="/apps/dat/training/xsl-training/2413009/data_output_dir/final-checkpoint/pytorch_lora_weights.safetensors",
    )
...
def get_aspect_ratio_size(size, max_size=(720, 1280), mod_value=16):
    w, h = size
