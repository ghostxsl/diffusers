...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="/apps/dat/cv/xsl/exp_animate/flux_controlnet_12k",
    )
...
def main(args):
    ...
    # Load controlnet
    controlnet = FluxControlNetModel.from_pretrained(args.controlnet_model_path, torch_dtype=dtype)
    ...
    for i, file in enumerate(img_list):
        ...
        out_img = np.concatenate(
            [pose_img.resize(args.resolution[::-1], 1), out], axis=1)
