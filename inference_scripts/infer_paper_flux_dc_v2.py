...
from diffusers.pipelines.vip.vip_flux_dc_pipeline import FluxPoseTransferPipeline
...
def main(args):
    ...
    pipe = FluxPoseTransferPipeline(
        scheduler=scheduler, vae=vae, transformer=transformer).to(device)
