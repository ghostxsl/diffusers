...
lora_file = "/xsl/wilson.xu/weights/lora_xsl/e100/pytorch_lora_weights.bin"
out_file = "/xsl/wilson.xu/weights/lora_xsl/e100/pytorch_lora_weights.safetensors"

newDict = dict()
# 新版diffusers需要改为pytorch_model.bin
checkpoint = torch.load(lora_file)
