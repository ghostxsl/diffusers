...
from diffusers.data import ImageVariationDataset, GroupImageVariationDataset, flux_collate_fn
...
def main(args):
    ...
    if alter_x_embedder:
        train_dataset = GroupImageVariationDataset(
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(transformer):
                ...
                if alter_x_embedder:
                    ...
                    noisy_model_input = torch.cat([noisy_model_input, refer_input], dim=1)
