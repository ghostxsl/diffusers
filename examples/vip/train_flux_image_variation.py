...
def save_models(output_dir, model, train_stage=0):
    ...
    for k, v in model.state_dict().items():
        if "time_text_embed" in k or "context_embedder" in k:
            iv_state_dict[k] = v
        if train_stage == 2 and ("attn.norm_q" in k or "attn.norm_k" in k):
            iv_state_dict[k] = v
...
def main(args):
    ...
    transformer._init_image_variation(
        ...
        use_guidance_embeds=False if args.train_stage == 2 else True,
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    if global_step % args.checkpointing_steps == 0:
                        ...
                        save_models(save_path, unwrap_model(transformer), args.train_stage)
    ...
    if accelerator.is_main_process:
        ...
        save_models(args.output_dir, transformer, args.train_stage)
