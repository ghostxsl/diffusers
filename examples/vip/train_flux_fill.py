...
from diffusers.data import FluxFillDataset, flux_fill_collate_fn
...
def main(args):
    ...
    transformer_lora_config = LoraConfig(
        ...
        target_modules=[
            "x_embedder", "timestep_embedder.linear_1", "timestep_embedder.linear_2",
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(transformer):
                ...
                masked_image = encode_vae_image(batch["masked_image_pixel_values"], vae, weight_dtype)
                mask = batch["mask"]
                ...
                latent_image_ids = batch["latent_image_ids"]
