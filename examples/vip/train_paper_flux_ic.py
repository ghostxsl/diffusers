...
def main(args):
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(transformer):
                ...
                packed_noisy_model_input = torch.cat([packed_noisy_model_input, packed_mask.detach(), packed_control_input], dim=-1)
    ...
    if accelerator.is_main_process:
        save_models(args.output_dir, unwrap_model(transformer))
