...
def save_models(output_dir, model, alter_x_embedder=False):
...
def main(args):
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    if global_step % args.checkpointing_steps == 0:
                        ...
                        save_models(save_path, unwrap_model(transformer), alter_x_embedder)
    ...
    if accelerator.is_main_process:
        ...
        save_models(args.output_dir, transformer, alter_x_embedder)
