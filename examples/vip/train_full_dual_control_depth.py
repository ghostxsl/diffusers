...
def main(args):
    ...
    if args.init_model:
        ...
        transformer.register_to_config(joint_attention_dim=64)
        transformer.register_to_config(pooled_projection_dim=None)

        from diffusers.models.vip.transformer_flux import TimestepProjEmbeddings
        time_text_embed = TimestepProjEmbeddings(transformer.inner_dim)
        ...
        transformer.context_embedder = nn.Linear(64, transformer.inner_dim)
