...
from diffusers.data import FluxIPADataset, flux_collate_fn, ModelEMA
...
def main(args):
    ...
    if use_guidance_embeds:
        ...
        guidance = guidance.repeat_interleave(args.train_batch_size, dim=0)
    else:
        guidance = None
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(transformer):
                ...
                model_pred = transformer(
                    ...
                    guidance=guidance.detach() if use_guidance_embeds else None,
