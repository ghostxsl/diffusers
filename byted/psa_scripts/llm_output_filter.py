...
def send_request(item):
    ...
    result_check_id_json = gpt_client.make_image_json_request(
        "", poster_check_id, [], [src_url, gen_url], max_tokens=4000, timeout=60)
    item.append(result_check_id_json)

    result_check_text_json = gpt_client.make_image_json_request(
        "", poster_check_text, [], [src_url, gen_url], max_tokens=4000, timeout=60
    )
    item.append(result_check_text_json)
    return item
