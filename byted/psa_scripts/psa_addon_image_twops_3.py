...
gemini_client = MLLMClient(model_name="gemini-2.5-flash", api_key="f1d66mV3iH5c651R0diqfBcmh1qzAo8I_GPT_AK")
...
def send_request(item):
    ...
    res_json = gemini_client.make_image_json_request("", prompt_check_id, [], [], image_pils=[src_image, res_image], max_tokens=6000, timeout=60)
