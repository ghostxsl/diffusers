...
gemini3_client = MLLMClient(model_name="gemini-3.1-fl", api_key="XpGAiljn5ZhzjpRn8Eo8BRvj1uWcaCmP_GPT_AK")
...
def send_request(item):
    ...
    #     max_token=4000,
    # )
    # gen_url1 = save_tos(encode_pil_bytes(result_resize["image"], False), headers={"Content-Type": "image/jpeg"})
    ...
    prompt_blurred_bg = mllm_make_image_request(
        meta_prompt_blur_bg,
    ...
    prompt_blurred_bg = "Redesign and generate a new poster with reference to the input poster image: " + prompt_blurred_bg
    ...
    #     max_token=4000,
    # )
    # gen_url3 = save_tos(encode_pil_bytes(res_91["image"], False), headers={"Content-Type": "image/jpeg"})
    ...
    # )
    # gen_url4 = save_tos(encode_pil_bytes(res_3_pro["image"], False), headers={"Content-Type": "image/jpeg"})
