...
--transformer_model_path=/mnt/bn/creative-algo/xsl/xsl-subject-1126/checkpoint-30000 \
--output_dir=/mnt/bn/creative-algo/xsl/xsl-poster-1201 \
--dataset_file=/mnt/bn/creative-algo/xsl/data/gpt_dataset/train.json,/mnt/bn/creative-algo/xsl/data/fei_0901_dataset/train.json,/mnt/bn/creative-algo/xsl/data/gemini_dataset/train.json,/mnt/bn/creative-algo/xsl/data/gemini_dataset/train_3_4.json \
