...
7. The output prompt should ensure the expression of natural language fluency, and expressions such as 'Prompt:' and 'Text layout:' should not appear.
