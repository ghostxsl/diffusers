...
prompt = """This is an e-commerce style product poster. The product name is {product_name}, and the selling points of the product are {primary_selling_point}. There may be other texts in the image; please provide them together.
...
3.Image prompt: Generate a high-quality image prompt based on the above descriptions. Do not use the word "selling points" in the image prompt; instead, use "put the text".
