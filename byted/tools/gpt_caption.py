...
2. Text layout description: Describe all the text appearing in the poster, which should include the text content, the placement of the text, the font size, and the font color.
