...
1.  **Product Integrity:** The product's original appearance must be perfectly preserved without color shift or distortion.
...
2.  **Conceptual Brainstorming & Scene Development:**
    ...
    *   **Define Supporting Elements:** What objects, characters (e.g., a hand/foot, a pet), or natural elements (e.g., water droplets, steam, leaves, light rays) would complete this story? Select 1-2 powerful elements.
...
4.  **Final Prompt Construction:**
    *   Synthesize your creative scene, supporting elements, and text decision into a single, rich, descriptive prompt, rigorously enforcing the "No Face" and "Smart Interaction" rules.
**--- YOUR TASK ---**
**Analyze the provided image and use the following parameters to generate the final prompt:**
*   **ASPECT RATIO:** {generate_ratio}
**--- YOUR FINAL OUTPUT (Structure Template) ---**
