...
2. Copywriting Vertical Arrangement Errors: Check whether the text rendered in the image has a vertically arranged layout, it refers to a paragraph of text rotated 90 degrees clockwise or counterclockwise.
3. Defect Existence Errors: Check whether there are defects in the image. Example: Defects on characters' hands/feet, etc.
4. If any of the above errors exist, answer "False" along with the reasons; otherwise, answer "True" to indicate that the image has passed the quality inspection. No need to provide reasons when the answer is True.
5. The answer should be in JSON format.

Quality Inspection Example:
{
“result”: False,
“product_name”: {"checking result":"True","reason”:””},
“primary_selling_points”: {"checking result":"True","reason”:””},
“secondary_selling_points”: {"checking result":"False","reason":"Each secondary selling point is repeated on the poster (appears twice) instead of only once.”},
“vertical_arrangement_errors”:{"checking result”:”False”,”reason”:”’Refined Leather Craftsmanship’ is arranged vertically on the right side of the image.”},
“unexpected_generation”: {"checking result”:”False”,”reason”:”There are defects on the model's hands in the image”}
}
...
def main(args):
    ...
    for item in tqdm(info_dict):
        try:
            ...
            item['gpt_result'] = json.loads(result_prompt)
