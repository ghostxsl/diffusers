...
negative_prompt = "Vague text, the details are vague and unclear, overexposure, low quality."
...
def parse_args():
    ...
    parser.add_argument(
        "--input_file",
        default="/mnt/bn/creative-algo/xsl/data/gpt_dataset/test.json",
        type=str,
        help="Path to image list on vos.")
    parser.add_argument(
        "--save_dir",
        default="qwen_lora_test",
        type=str,
