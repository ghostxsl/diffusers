...
pipe.load_lora_weights("/mnt/bn/creative-algo/qwen-lora-xsl/pytorch_lora_weights.safetensors")
pipe.fuse_lora(lora_scale=1.0)
pipe.unload_lora_weights()

out_dir = "gpt_lora_test"
os.makedirs(out_dir, exist_ok=True)

row_dict = load_file("/mnt/bn/creative-algo/xsl/data/gpt_dataset/test.json")
