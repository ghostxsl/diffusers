...
from diffusers.data import FluxKontextDataset, flux_kontext_collate_fn
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(transformer):
                ...
                cond_model_input = batch["cond_image_latents"].to(dtype=weight_dtype)
                ...
                latent_image_ids = torch.cat([batch["latent_image_ids"], batch["cond_image_ids"]], dim=0)
