...
from diffusers.data.clients.config import LabCVAppKey, LabCVAppSecret
import diffusers.data.errno as err
from diffusers.data.tos import url_to_bytes, save_tos, make_key
...
LabcvVproxyCli.set_euler_client_middleware(set_token_middleware)
LabcvVproxyCli.set_euler_client_middleware(client_logid)
LabcvVproxyCli.set_euler_client_middleware(euler.base_compat_middleware.gdpr_auth_middleware)
