import logging
from diffusers.data.byted.middleware import set_token_middleware
...
AdCreativeTestTextTitle_Cli.set_euler_client_middleware(set_token_middleware)
AdCreativeTestTextTitle_Cli.set_euler_client_middleware(euler.base_compat_middleware.gdpr_auth_middleware)
