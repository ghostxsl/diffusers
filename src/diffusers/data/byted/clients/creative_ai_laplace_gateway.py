...
AdCreativeAi_Laplace_GatewayCli.set_euler_client_middleware(set_token_middleware)
...
AdCreativeAi_Laplace_GatewayCli.set_euler_client_middleware(euler.base_compat_middleware.gdpr_auth_middleware)
