...
class YOLOv8FaceDet(object):
    ...
    def __call__(self, img):
        ...
        input_img, newh, neww, padh, padw = self.resize_image(cv2.cvtColor(img, cv2.COLOR_RGB2BGR))
        scale_h, scale_w = img.shape[0] / newh, img.shape[1] / neww
        ...
        return det_bboxes, det_conf, det_classid, landmarks.reshape([-1, 5, 3])
