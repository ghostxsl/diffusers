...
def apply_custom_gc_to_transformer_block(module: nn.Module, ac_freq=1):
...
class WanTransformer3DModel(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin, CacheMixin):
    ...
    def _enable_custom_gradient_checkpointing(self):
        for name, transformer_block in self.blocks.named_children():
            transformer_block = apply_custom_gc_to_transformer_block(transformer_block)
            self.blocks.register_module(name, transformer_block)
