...
class FluxImg2ImgPipeline(DiffusionPipeline, FluxLoraLoaderMixin):
    ...
    def __call__(
        ...
        guidance_vector: float = 3.0,
        guidance_scale: float = 1.0,
        num_images_per_prompt: Optional[int] = 1,
        refer_image: Optional[PipelineImageInput] = None,
        ...
        **kwargs
        ...
        # refer_image
        refer_image = self.image_processor.preprocess(refer_image, height=height, width=width)
        refer_image = refer_image.to(device=device, dtype=prompt_embeds.dtype)
        refer_latents = self._encode_vae_image(image=refer_image, generator=generator)
        refer_latents = self._pack_latents(
            refer_latents,
