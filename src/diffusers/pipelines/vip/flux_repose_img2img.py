...
class FluxRePoseImg2ImgPipeline(DiffusionPipeline, FluxLoraLoaderMixin):
    r"""
    ...
    def __call__(
        ...
        if self.image_encoder is not None:
            ip_adapter_image = ip_adapter_image.resize((width, height), 1)
            ...
            if self.x_embedder:
                ref_image = self.image_processor.preprocess(
                    ip_adapter_image, height=height, width=width)
