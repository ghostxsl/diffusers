...
class FluxPoseTransferPipeline(DiffusionPipeline, FluxLoraLoaderMixin):
    ...
    def __call__(
        ...
        **kwargs
        ...
        image_embeds, negative_image_embeds = self.encode_image_embeds(
            image, height, width, device, num_images_per_prompt)
        ...
        # 5.1 Prepare txt_ids
        txt_ids = latent_image_ids.clone()
        txt_ids[..., 0] = 1

        # 5.2 Prepare control_image
